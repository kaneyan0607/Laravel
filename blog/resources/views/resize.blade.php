    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <br />
                <img src="/Laravel/blog/images/{{ Session::get('imageName') }}" class="img-responsive img-thumbnail">
            </div>
            <div class="col-md-4">
                <strong>Thumbnail Image:</strong>
                <br />
                <img src="/Laravel/blog/thumbnail/{{ Session::get('imageName') }}" class="img-thumbnail" />
            </div>
        </div>
        @endif
    </div>
